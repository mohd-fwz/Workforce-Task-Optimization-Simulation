      ...
      <div className="flex border-b border-dark-border">
        {tabs.map((tab) => (
          ...
          >
            ...
            <span>{tab.label}</span>
            {tab.count !== null && (
              <span className="bg-dark-bg px-2 py-0.5 rounded text-xs">
                {tab.count}
              </span>
            )}
          </button>
      ...
      <div className="flex-1 p-4 overflow-auto">
        ...
        {activeView === 'data' && (
          <div className="space-y-4">
            <div>
              <h3 className="text-sm font-semibold text-white mb-2">Priority Queue</h3>
              <pre className="bg-dark-bg p-3 rounded text-xs text-gray-300 overflow-auto max-h-40">
                {JSON.stringify(priorityQueue, null, 2)}
              </pre>
            </div>

            <div>
              <h3 className="text-sm font-semibold text-white mb-2">Task Queue</h3>
              <pre className="bg-dark-bg p-3 rounded text-xs text-gray-300 overflow-auto max-h-40">
            ...
            <div>
              <h3 className="text-sm font-semibold text-white mb-2">Staff HashMap</h3>
              <pre className="bg-dark-bg p-3 rounded text-xs text-gray-300 overflow-auto max-h-40">
                {JSON.stringify(
