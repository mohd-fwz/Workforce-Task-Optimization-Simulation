      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="bg-accent-green hover:bg-green-500 text-white p-2 rounded transition"
              ...
              <div className="flex items-start justify-between mb-2">
                <div className="flex items-center gap-2">
                  <div className="relative">
                    ...
                    <div className={`absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-full ${getStatusColor(member.status)} border-2 border-white`} />
                  </div>
                  <div>
